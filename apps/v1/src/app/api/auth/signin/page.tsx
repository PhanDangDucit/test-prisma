import { FormLoginProvider } from '@/app/ui/auth/form-login-provider';
import { ImagePartAuth } from '@/app/ui/auth/image-part-auth';
            ...
            <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
                <div className="max-w-md w-full p-6">
                    ...
                    <div className="mt-4 flex flex-col lg:flex-row items-center justify-between">
                        <div className="w-full lg:w-1/2 mb-2 lg:mb-0 relative">
                            <FormLoginProvider/>
                        </div>
                    ...
                    <form action={login} className="space-y-4">
                        ...
                        <div>
                            <button type="submit" className="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Sign In</button>
                        </div>
                    </form>
                    <div className="mt-4 text-sm text-gray-600 text-center">
                        <p>
                            Already have an account? {' '}
                            <Link href={`/api/auth/signup`} className="text-black hover:underline">
                                Sign Up here
                            </Link>
                        </p>
